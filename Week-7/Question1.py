...
x_axis = [] # the series in which u enter the values, matters
y_axis_one = []
y_axis_second = []
...
plt.plot(x_axis, y_axis_one, color="#f00", marker = "^", linewidth = 2, label="for rain")
plt.plot(x_axis, y_axis_second, marker = "o", linewidth = 2, label="for temperature")
